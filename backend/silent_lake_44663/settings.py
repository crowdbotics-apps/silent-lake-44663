"""
Django settings for silent_lake_44663 project.
...
ROOT_URLCONF = 'silent_lake_44663.urls'
...
WSGI_APPLICATION = 'silent_lake_44663.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_lake_44663 API",
    "DESCRIPTION": "API documentation for silent_lake_44663 App",
    "VERSION": "v1",
}
